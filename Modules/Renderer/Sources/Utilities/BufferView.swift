...
public struct BufferView<Element> {
    ...
    public init(
        ...
        guard let buffer = device.makeBuffer(
            bytes: array,
            length: MemoryLayout<Element>.stride * array.count,
    ...
    public func assign(_ value: Element, at index: Int = 0) {
        precondition(
            index <= count - 1,
...
extension MTLRenderCommandEncoder {
    ...
    public func setVertexBuffer<T>(_ vertexBuffer: BufferView<T>?, offset: Int, index: Int) {
        setVertexBuffer(
            vertexBuffer?.buffer,
            offset: offset,
            index: index
    ...
    public func setFragmentBuffer<T>(_ fragmentBuffer: BufferView<T>?, offset: Int, index: Int) {
        setFragmentBuffer(
